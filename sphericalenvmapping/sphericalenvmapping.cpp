...
public:
	...
	{
//<<<<<<< HEAD
//		loadMesh("./../data/models/chinesedragon.dae", &meshes.object, vertexLayout, 0.05f);
//=======
...
//>>>>>>> 606c8c3c79dac94b17652fd33263146df5e652cb
	...
	{
		uboVS.projection = glm::perspective(deg_to_rad(45.0f), (float)ScreenRect.Width / (float)ScreenRect.Height, 0.1f, 256.0f);

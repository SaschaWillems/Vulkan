...
public: 
	...
	void handleKeyEvent(const vks::VirtualKey virtualKey, const bool isPressed, const uint32_t rawKeyCode);
	...
	*/
	...
	virtual void onKeyEvent(const vks::VirtualKey virtualKey, const bool isPressed, const uint32_t rawKeyCode);

...
void VulkanExampleBase::setupRenderPass()
{
	...
	// cannot be much sure here what the previous work is
	// assumably it is the semaphore to vkQueueSubmit, otherwisely it is the user's resposibility to otherwisely synchronize
	dependencies[0].srcStageMask = this->submitPipelineStages;

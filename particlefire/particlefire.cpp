...
public:
	...
	void buildCommandBuffers()
	{
		...
		renderPassBeginInfo.renderArea.extent.width  = (uint32_t)ScreenProperties.Width;
		renderPassBeginInfo.renderArea.extent.height = (uint32_t)ScreenProperties.Height;
	...
	void updateUniformBuffers()
	{
		...
		uboVS.projection = glm::perspective(glm::radians(60.0f), (float)ScreenProperties.Width / (float)ScreenProperties.Height, 0.001f, 256.0f);
		...
		uboVS.viewportDim = glm::vec2((float)ScreenProperties.Width, (float)ScreenProperties.Height);

...
public:
	...
	void updateUniformBuffers()
	{
		...
		// Occluder
		uboVS.visible = 1.0f;
		uboVS.model = glm::scale(glm::mat4(1.0f), glm::vec3(20.0f));
		...
		uboVS.model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -10.0f));
		uboVS.model = glm::scale(uboVS.model, glm::vec3(2.5f));
		...
		uboVS.model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, 10.0f));
		uboVS.model = glm::scale(uboVS.model, glm::vec3(3.5f));

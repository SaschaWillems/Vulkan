...
public:
	...
	void prepareDescriptorBuffer()
	{
		...
		uniformDescriptor.layoutSize = vks::tools::alignedSize(static_cast<uint32_t>(uniformDescriptor.layoutSize), static_cast<uint32_t>(descriptorBufferProperties.descriptorBufferOffsetAlignment));
		combinedImageDescriptor.layoutSize = vks::tools::alignedSize(static_cast<uint32_t>(combinedImageDescriptor.layoutSize), static_cast<uint32_t>(descriptorBufferProperties.descriptorBufferOffsetAlignment));

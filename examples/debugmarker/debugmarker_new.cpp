...
public:
	...
	void buildCommandBuffers()
	{
		...
		for (int32_t i = 0; i < drawCmdBuffers.size(); ++i)
		{
			...
			DebugMarker::beginRegion(drawCmdBuffers[i], "D3DUSERDEFINEDANNOTATIONisVULKANDEBUGMARKERBEGINREGION Render scene", glm::vec4(0.5f, 0.76f, 0.34f, 1.0f));
			...
			// DebugMarker::beginRegion(drawCmdBuffers[i], "Toon shading draw", glm::vec4(0.78f, 0.74f, 0.9f, 1.0f));
			 DebugMarker::beginRegion(drawCmdBuffers[i], "D3DUSERDEFINEDANNOTATIONisVULKANDEBUGMARKERBEGINREGION Toon shading draw", glm::vec4(0.78f, 0.74f, 0.9f, 1.0f));
			...
			if (wireframe)
			{
				...
				DebugMarker::beginRegion(drawCmdBuffers[i], "D3DUSERDEFINEDANNOTATIONisVULKANDEBUGMARKERBEGINREGION Wireframe draw", glm::vec4(0.53f, 0.78f, 0.91f, 1.0f));
			...
			if (glow)
			{
				...
				DebugMarker::beginRegion(drawCmdBuffers[i], "D3DUSERDEFINEDANNOTATIONisVULKANDEBUGMARKERBEGINREGION Apply post processing", glm::vec4(0.93f, 0.89f, 0.69f, 1.0f));

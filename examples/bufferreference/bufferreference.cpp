		...
		*/
		{
			...
			VkPushConstantRange pushConstantRange =
				vks::initializers::pushConstantRange(VK_SHADER_STAGE_ALL, sizeof(uint32_t), 0);
		...
		*/
		{
			...
			vkCmdPushConstants(commandBuffer, pipelineLayout, VK_PIPELINE_BIND_POINT_COMPUTE, 0, sizeof(uint32_t), &addr);

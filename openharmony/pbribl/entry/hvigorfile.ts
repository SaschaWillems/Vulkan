  ...
  plugins: [
    {
      ...
      apply(node: any) {
        ...
        copyFiles(path.join(shaderPath, 'glsl/pbribl'), path.join(rawfile, 'shaders/glsl/pbribl'), /^.+\..+$/);
        ...
        copyFiles(path.join(assetPath,  'textures/hdr'), path.join(rawfile, 'textures/hdr'), 'pisa_cube.ktx');
      }
    }
  ]
}

  ...
  plugins: [
    {
      ...
      apply(node: any) {
        ...
        copyFiles(path.join(shaderPath, 'glsl/texturemipmapgen'), path.join(rawfile, 'shaders/glsl/texturemipmapgen'), /\.spv$/);
        copyFiles(path.join(assetPath,  'models'), path.join(rawfile, 'models'), 'tunnel_cylinder.gltf');

  ...
  plugins: [
    {
      ...
      apply(node: any) {
        ...
        copyFiles(path.join(shaderPath, 'glsl/texturecubemap'), path.join(rawfile, 'shaders/glsl/texturecubemap'), /\.spv$/);
        ...
        copyFiles(path.join(assetPath,  'textures'), path.join(rawfile, 'textures'), 'cubemap_yokohama_rgba.ktx');
      }
    }
  ]
}
